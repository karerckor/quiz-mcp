...
app.get("/authorize", async (c) => {
	...
	return renderApprovalDialog(c.req.raw, {
		...
		server: {
			description:
				"Quiz MCP lets AI assistants build interactive quizzes for you and " +
				"collect your answers. Approving this app gives it access to create " +
				"and read quizzes scoped to your account — no quizzes from other users " +
				"are visible. You can revoke access at any time from your account settings.",
			name: "Quiz MCP",
		},
		setCookie,
		state: { oauthReqInfo },
